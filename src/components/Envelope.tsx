  ...
  return (
    <div className="container h-screen grid place-items-center">
      ...
      <motion.div
        ...
        animate={isFlapped ? { y: 180, opacity: showHeart ? 0 : 1 } : { y: 0 }}
        ...
        <div className="envelope relative w-[300px] h-[230px]">
          <motion.div
            ...
            initial={{
              y: 0,
              opacity: 1,
              height: currentPhotoIndex === 4 ? 270 : 210,
            }}
            animate={
              isFlapped
                ? {
                ...
                >
                  ...
                  {currentPhotoIndex === 4 && !showProposal && (
                    ...
                    >
                      ...
                      >
                        To the love of my life, From the moment I met you,
                        you’ve had a hold on my heart. With each passing day, my
                        love for you grows in ways I never expected. The more I
                        look at you, the more I appreciate the beauty inside and
                        out that makes you so special. I don’t usually put my
                        feelings into words like this, but I want you to know
                        just how much you mean to me. I’m also so proud of you
                        for handling our LDR with so much strength and love it
